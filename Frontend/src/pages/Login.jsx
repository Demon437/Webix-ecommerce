...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('✅ Login successful in Login.jsx:', user);

            toast.success('Logged in successfully!');

            // Check if there's a redirect URL stored from checkout attempt
                ...
                <div className="absolute inset-0 flex items-center justify-center p-12">
                    <div className="text-center text-white">
                        ...
                        <p className="text-white/70 max-w-md">
                            Sign in to your account to access your orders, saved items, and personalized recommendations.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-neutral-900 mt-8">Sign in</h1>
                        <p className="text-neutral-500 mt-2">Welcome back to your account</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm">
                        ...
                        <p className="text-center text-sm text-neutral-500 mt-6">
                            ...
                            <Link to={createPageUrl('Register')} className="text-neutral-900 font-medium hover:underline">
                                Create one
                            </Link>
                        </p>
                    </div>
